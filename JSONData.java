...
public class JSONData {
    ...
    public static void main(String[] args){
        Path file = Paths.get("/Users/rgelpi1/Documents/Java/blicket/new.json");
        JSONData data = new JSONData(file);
        data.printToCsv("/Users/rgelpi1/Documents/2019/Explore-Exploit/test.csv");
    }
}
