...
public class Trials {
    ...
    public Trials(ExcelParticipant e){
        this.subjectID = e.subjectId;
        this.cond = e.condition.contains("e"); //Near = true
        this.dist = e.distractor.contains("b"); //blue = true
        this.FC1 = new BlicketTrial(e.codes.getStimulus(e.values[25]),cond,dist,e.codes.getStimulus(e.values[26]));
        this.FC2 = new BlicketTrial(e.codes.getStimulus(e.values[27]),cond,dist,e.codes.getStimulus(e.values[28]));
        this.FC3 = new BlicketTrial(e.codes.getStimulus(e.values[29]),cond,dist,e.codes.getStimulus(e.values[30]));
        this.FC4 = new BlicketTrial(e.codes.getStimulus(e.values[31]),cond,dist,e.codes.getStimulus(e.values[32]));
        this.FC = new BlicketTrial[]{this.FC1, this.FC2, this.FC3, this.FC4};

        this.excluded = !e.inclusion;
